...
public class ListOfVoitures extends ArrayList<Voiture> {
    ...
    private ListOfVoitures()
    {
        ...
        add(new Voiture(15,"M4","BMW",65120.07,"https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/2014_Canadian_International_AutoShow_0148_%2812646102484%29.jpg/1024px-2014_Canadian_International_AutoShow_0148_%2812646102484%29.jpg","Voiture sportive et puissante symbole du savoir faire de la marque BMW avec un moteur 6 cylindres en ligne de 3.0L, 450ch et 550nm de couple"));
